    ...
    >
      ...
      <div>
        ...
        <div className="flex justify-between mt-4">
          <div className="font-Suprema font-normal text-[14px] text-[#AEAEAE]">Weekly payment limit</div>
          <div className="text-Suprema font-semibold md:text-[14px] text-[12px] text-[#404040]">$350.60 / $4000</div>
        </div>
      </div>
